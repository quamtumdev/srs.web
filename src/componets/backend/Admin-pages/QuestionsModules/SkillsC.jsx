...
function SkillsC({ onSaveSkills, selectedSkills }) {
  ...
  return (
    <div>
      ...
      <Form.Group className="mb-3" controlId="formSubjectSkill">
        <Form.Label>Select Skill(s)</Form.Label>
        <Select
          options={options} // Pass the skill options
