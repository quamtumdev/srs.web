          ...
          <div className="row">
            <div className="col-sm-12">
              <h2 className="subs-title">
                BEST ClASSROOM PROGRAM FOR JEE PREPARATION
              </h2>
            </div>
          </div>
            ...
            <div id="collapseOne" className="card-collapse collapse">
              <div className="award-list jee-award-list d-flex align-items-center">
                ...
                <p>
                  ...
                  providing everything you need to succeed in JEE without any
          ...
          <div className="course-card">
            ...
            <div id="course3" className="card-collapse collapse">
              <div className="award-list jee-award-list d-flex align-items-center">
                ...
                <p>
                  Online Test Series (OTS) is designed according to JEE Main +
      ...
      <div className="card content-sec">
        <div className="card-body">
          <div className="row">
            <div className="col-sm-12">
              <h2 className="subs-title">
                JEE ONLINE STUDY WITH SRS EDUCARES LEARNING APP
              </h2>
            </div>
          </div>
          <div className="course-card">
