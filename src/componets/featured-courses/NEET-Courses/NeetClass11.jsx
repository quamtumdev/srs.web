          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="instructor-wrap border-bottom-0 m-0">
                <span className="web-badge mb-3">Target Year 2026</span>
              </div>
              <h2>NEET NURTURE BATCH </h2>
              <p>Class 10th to 11th Moving Student</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="col-lg-8">
              <div className="card overview-sec">
                <div className="card-body">
                  <h2 className="subs-title">NEET (PRE-MEDICAL)-2026 </h2>
                  ...
                  <p className="text-justify">
                    ...
                    curriculum is crafted specifically for NEET 2026 candidates,
                    covering both 11th-grade and board preparations.
                  </p>
                  <p>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="award-list jeebatch d-flex align-items-center">
                        ...
                        <p>
                          850+ Online & Offline Classes (Physics 250+, Chemistry
                          250+ & Biology 350+) with Lecture of 90 Minute Each.
                        </p>
                      </div>
                      <div className="award-list jeebatch d-flex align-items-center">
                        <span className="award-icon jee-icon">
                        ...
                        <p>
                          8000+ Questions Practice accessible in both Online and
                          Offline mode.
                        </p>
                      </div>
                ...
                <div className="card feature-sec">
                  <div className="card-body">
                    <div className="cat-title">
                      <h4>Course Fee for 11th Class- Targeting NEET 2026</h4>
                    </div>
                    ...
                    <div className="award-list jee-award-list d-flex align-items-center">
                      ...
                      <p>
                        <b>Tuition Fee</b> <span>₹ 1,20,000</span>
                      </p>
                    </div>
                    <div className="award-list jee-award-list d-flex align-items-center">
                      <span className="award-icon jee-icon">
                      ...
                      <p>
                        <b>Total Fee</b> <span>₹ 1,35,000</span>
                      </p>
                    </div>
                    <div className="award-list jee-award-list d-flex align-items-center">
                      <span className="award-icon jee-icon">
